...
g=l.body.clientWidth,e=l.body.scrollLeft,h=l.body.scrollTop);var n=j(a);c=f.options(a);var m,p;m=f.borderSize(b);p=a._group?a._panelWidth:b.width();a=Math.min(a._panelHeight,c.maxHeight);b=d?b.offset().left:n.offset().left;switch(c.direction){case "top":d=n.offset().top+n.outerHeight()-a-m.height;break;case "bottom":d=n.offset().top;break;default:d=n.offset().top+(n.outerHeight()>>1)-(a>>1)-(m.height>>1)}d<h+c.maxTop&&(d=n.offset().top);d+a>h+k&&(d=n.offset().top+n.outerHeight()-a-m.height);d+a>h+
k&&(d=h+k-a-m.height);b+p>e+g&&(b=e+g-p-m.width);0>b&&(b=0);0>d&&(d=c.maxTop);return{x:b,y:d,w:p,h:a}},show:function(){var a=this,b=j(a),c=f.options(a),d,e=a._panel,h,g;b.blur();e.is(":visible")||(d=f.borderSize(e),e.show().css({height:b.outerHeight()-d.height,left:b.offset().left,top:b.offset().top}),a._group&&e.css("width",a._panelWidth),h=f.panelPosition(a,e,c,!0),g={height:h.h,left:h.x,top:h.y},1<a._column&&(g.width=a._showWidth,e.css("width",b.outerWidth())),"top"==c.direction&&e.css("top",b.offset().top+
