...
g=l.body.clientWidth,e=l.body.scrollLeft,h=l.body.scrollTop);var p=j(a);c=f.options(a);var m,n;m=f.borderSize(b);n=parseInt(a._showWidth);console.log(b.width(),n);a=Math.min(a._panelHeight,c.maxHeight);b=d?b.offset().left:p.offset().left;switch(c.direction){case "top":d=p.offset().top+p.outerHeight()-a-m.height;break;case "bottom":d=p.offset().top;break;default:d=p.offset().top+(p.outerHeight()>>1)-(a>>1)-(m.height>>1)}d<h+c.maxTop&&(d=p.offset().top);d+a>h+k&&(d=p.offset().top+p.outerHeight()-a-
m.height);d+a>h+k&&(d=h+k-a-m.height);b+n>e+g&&(b=e+g-n-m.width);0>b&&(b=0);0>d&&(d=c.maxTop);return{x:b,y:d,w:n,h:a}},show:function(){var a=this,b=j(a),c=f.options(a),d,e=a._panel,h,g;b.blur();e.is(":visible")||(d=f.borderSize(e),e.show().css({height:b.outerHeight()-d.height,left:b.offset().left,top:b.offset().top}),a._group&&e.css("width",a._panelWidth),h=f.panelPosition(a,e,c,!0),g={height:h.h,left:h.x,top:h.y},1<a._column&&(g.width=a._showWidth,e.css("width",b.outerWidth())),"top"==c.direction&&
e.css("top",b.offset().top+1),a._panel.animate(g,k.speed,function(){n(c.show)&&c.show.call(a)}),k.shadow&&u.show().css({width:e.width(),height:b.outerHeight()-d.height,left:b.offset().left,top:b.offset().top}).animate({height:h.h,left:h.x+6,top:h.y+6},k.speed),r.push(a))},hide:function(){var a=this,b=f.options(a),c=j(this),d=this._panel,e=f.borderSize(d),g;g=d.css("z-index");d.css("z-index",g-1);"top"==b.direction&&d.css("top",parseInt(d.css("top"))+1);e={height:c.outerHeight()-e.height,left:c.offset().left,
top:c.offset().top};1<a._column&&(e.width=c.outerWidth());d.animate(e,k.speed,function(){d.hide();d.css("z-index",g);n(b.hide)&&b.hide.call(a)});k.shadow&&u.hide()},hideAll:function(){for(var a;a=r.pop();)f.hide.call(a)},reset:function(a,b){var c=this._panel,d=f.options(this),e="",g,j=0;this._initSelectedIndex=-1;d.maxHeight=this._origMaxHeight;q(b)||(d.selectedValue=b);for(g in a)e+='<li><a href="javascript:;" rel="'+g+'">'+a[g]+"</a></li>",j++;1==j&&(e+="<li>&nbsp;</li>");c.empty().html("<ul>"+
e+"</ul>");f.panelInit(this,c,d);f.panelArrange(this,c,d);f.setValue.call(this,d.selectedValue)},haltEvent:function(a){a=a||m.event;a.stopPropagation?a.stopPropagation():a.cancelBubble=!0;return!1},borderSize:function(a){a=j(a);return{width:parseInt(a.css("border-left-width"))+parseInt(a.css("border-right-width")),height:parseInt(a.css("border-top-width"))+parseInt(a.css("border-bottom-width"))}},options:function(a){return a._options?a._options:{}},value:function(){return this._value?this._value.val():
this.value},caption:function(){return this._value?this._value[0].getAttribute("rel"):this.getAttribute("rel")}};j.vselect={config:function(a){return"undefined"==typeof k[a]?void 0:k[a]},setConfig:function(a,b){switch(typeof a){case "object":for(var c in a)k[c]=a[c];return;case "array":for(c=0;c<a.length;c++)k[c]=a[c];return}k[a]=b},style:function(a){return"undefined"==typeof g[a]?void 0:g[a]},setStyle:function(a,b){switch(typeof a){case "object":for(var c in a)g[c]=a[c];return;case "array":for(c=
0;c<a.length;c++)g[c]=a[c];return}g[a]=b},hide:f.hideAll};j.fn.extend({vselect:function(){return f.init.apply(this,arguments)},vselectShow:function(){var a=arguments;return this.each(function(){f.show.apply(this._panel?this:j(this).parent()[0],a)})},vselectHide:function(){var a=arguments;return this.each(function(){f.hide.apply(this._panel?this:j(this).parent()[0],a)})},vselectValue:function(){return 1>this.size()?null:f.value.apply(this[0])},vselectSetValue:function(a){return 1>this.size()?null:
f.setValue.call(this.parent()[0],a)},vselectClickValue:function(a){return 1>this.size()?null:f.clickValue.call(this.parent()[0],a)},vselectCaption:function(){return 1>this.size()?null:f.caption.call(this[0])},vselectReset:function(){var a=arguments;return this.each(function(){f.reset.apply(this._panel?this:j(this).parent()[0],a)})}})})(jQuery,document,window);
